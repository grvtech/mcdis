...
public class Complications {
	...
	public Complications(Values reti, Values lther, Values lblind, Values micro, Values macro, Values renf, Values dial, Values neuro, Values fulcer, Values amput, Values impot, Values cad,
			Values cvd, Values pvd, Values rplant) {
		super();
		this.reti = reti;
		this.lther = lther;
		this.lblind = lblind;
