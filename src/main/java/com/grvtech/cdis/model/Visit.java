...
public class Visit {
	...
	public Visit(Values sbp, Values dbp, Values weight, Values smoke, Values aer, Values hipo, Values acglu, Values pcglu, Values neuro, Values psyco, Values depr, Values height, Values foot,
			Values rpathscr) {
		super();
		this.sbp = sbp;
		this.dbp = dbp;
	...
	public Visit(HashMap<String, Values> map) {
		super();
